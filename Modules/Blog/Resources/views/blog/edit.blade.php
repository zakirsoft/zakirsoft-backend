                    ...
                    <div class="col-md-6 offset-md-3">
                        <form class="form-horizontal" action="{{ route('module.post.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input value="{{ $post->title }}" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Blog Title">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="editor2" type="text" class="form-control" name="description" placeholder="Write description of post... ">{{ $post->description }}</textarea>
                                    ...
                                    <select name="tags[]" class="select2bs4 @error('tags') is-invalid @enderror" style="width: 100%;" multiple data-placeholder="Select Tag">
                                        @foreach ($tags as $tag)
                                            @foreach ($post->tags as $postTag)
                                                <option {{ $tag->id == $postTag->id ? 'selected':'' }}  value="{{ $tag->id }}">{{ $tag->name }}</option>
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-3 col-sm-4">
                                    <button type="submit" class="btn btn-success"><i class="fas fa-sync"></i>&nbsp;Update Post</button>
                                </div>
                            </div>
                        </form>
                    </div>
