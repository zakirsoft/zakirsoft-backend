                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="main" method="" action="">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Purpose</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="purpose" id="name" placeholder="Enter Purpose of Testimonial (Not visible)">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Content</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" class="form-control" name="content" id="content" placeholder="Write Testimonial content here.... " rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
