...
<div class="loader-bg">
    ...
    <li>
    <div class="media">
    <img class="img-radius" src="{{ asset('website') }}/jpg/avatar-1.jpg" alt="Generic placeholder image">
    ...
    <li>
    <div class="media">
    <img class="img-radius" src="{{asset('website')}}/jpg/avatar-3.jpg" alt="Generic placeholder image">
    <div class="media-body">
    ...
    <li>
    <div class="media">
    <img class="img-radius" src="{{ asset('website') }}/jpg/avatar-2.jpg" alt="Generic placeholder image">
    <div class="media-body">
    ...
    <div class="dropdown-primary dropdown">
    <div class="dropdown-toggle" data-toggle="dropdown">
    <img src="{{ asset('website') }}/jpg/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
    <span>John Doe</span>
    ...
    <img class="media-object img-radius img-radius" src="{{asset('website')}}/jpg/avatar-3.jpg" alt="Generic placeholder image ">
    ...
    <a class="media-left" href="#!">
    <img class="media-object img-radius" src="{{asset('website')}}/jpg/avatar-2.jpg" alt="Generic placeholder image">
    <div class="live-status bg-success"></div>
    </a>
    <div class="media-body">
    ...
    <a class="media-left" href="#!">
    <img class="media-object img-radius" src="{{asset('website')}}/jpg/avatar-3.jpg" alt="Generic placeholder image">
    <div class="live-status bg-success"></div>
    </a>
    <div class="media-body">
    ...
    <a class="media-left" href="#!">
    <img class="media-object img-radius" src="{{asset('website')}}/jpg/avatar-4.jpg" alt="Generic placeholder image">
    ...
    <img class="media-object img-radius img-radius m-t-5" src="{{asset('website')}}/jpg/avatar-2.jpg" alt="Generic placeholder image">
    </a>
...
<script src="{{asset('website')}}/js/jquery.flot.categories.js" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="{{asset('website')}}/js/curvedlines.js" type="2d8d78e876b340f9029c575b-text/javascript"></script>
<script src="{{asset('website')}}/js/jquery.flot.tooltip.min.js" type="2d8d78e876b340f9029c575b-text/javascript"></script>
...
<script  src="https://maps.google.com/maps/api/js?sensor=true" type="2d8d78e876b340f9029c575b-text/javascript"></script>
...
<script src="{{asset('website')}}/js/vertical-layout.min.js" type="2d8d78e876b340f9029c575b-text/javascript"></script>
...
<script src="{{asset('website')}}/js/rocket-loader.min.js" data-cf-settings="2d8d78e876b340f9029c575b-|49" defer=""></script></body>
