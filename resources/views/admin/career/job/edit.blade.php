            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">Edit Job Post</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-10">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('jobpost.update', $post->id) }}">
                                        @method('PUT')
                                        @csrf
                                        <div class="row justify-content-center">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="type" class="form-control @error('type') is-invalid @enderror">
                                                        <option {{ $post->type == "Full Type" ? 'selected':'' }} value="Full Type">Full Type</option>
                                                        <option {{ $post->type == "Half Type" ? 'selected':'' }} value="Half Type">Half Type</option>
                                                        <option {{ $post->type == "Freelance" ? 'selected':'' }} value="Freelance">Freelance</option>
                                                    </select>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('salary') is-invalid @enderror" name="salary" id="salary" placeholder="Enter salary" value="{{ $post->salary }}">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" id="link" placeholder="Enter link" value="{{ $post->link }}">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor1" type="text" class="form-control" name="short_description" rows="5">{{ $post->short_description }}</textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor2" type="text" class="form-control" name="long_description" rows="5">{{ $post->long_description }}</textarea>
