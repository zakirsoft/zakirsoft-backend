                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('downloads') is-invalid @enderror" name="downloads" id="downloads" placeholder="Total Downloads" value="{{ $subcompany->downloads }}">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('views') is-invalid @enderror" name="views" id="views" placeholder="Total Views" value="{{ $subcompany->views }}">
