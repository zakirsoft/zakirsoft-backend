                                    ...
                                    <div class="latest-update-box">
                                        <div class="row p-t-20 p-b-30">
                                            <div class="col-auto text-right update-meta p-r-0">
                                                <img src="{{asset('website')}}/jpg/avatar-4.jpg" alt="user image"
                            ...
                            <div class="card new-cust-card">
                                ...
                                <div class="card-block">
                                    <div class="align-middle m-b-35">
                                        <img src="{{asset('website')}}/jpg/avatar-2.jpg" alt="user image"
                                    ...
                                    <div class="align-middle m-b-35">
                                        <img src="{{asset('website')}}/jpg/avatar-3.jpg" alt="user image"
                                            class="img-radius img-40 align-top m-r-15">
                                        <div class="d-inline-block">
                                            <a href="#!">
                                                <h6>John Doue</h6>
                                        ...
                                        <div class="input-group input-group-button">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-primary waves-effect waves-light"
                                                    type="button"><i class="feather icon-message-circle"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
